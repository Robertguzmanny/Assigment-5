...
console.log(
  ...
  ". The BMI of Lucas is ",
  LucasBMI,
  ". Peter's BMI is higher than Lucas's BMI that is",
  compare,
  "."
);
console.log("");
...
if (compare == false) {
  console.log(
    `Peter's BMI, ${PeterBMI}, is less than Lucas's which is ${LucasBMI}.`
  );
} else {
  console.log(
    `Peter's BMI, ${PeterBMI}, is more than Lucas's which is ${LucasBMI}`
  );
}
console.log("");
console.log("Part D");
